<template>
<CSidebar fixed :minimize="minimize" :show="show" class="sidebar" @update:show="(value) => $store.dispatch('components/sets', ['sidebarShow', value])">
    ...
    <CSidebarMinimizer class="d-md-down-none" @click.native="$store.dispatch('components/sets', ['sidebarMinimize', !minimize])" />
</CSidebar>
</template>
