...
<div class="test">
    <el-row style="margin-bottom: 10px">
        <el-col :span="5">
            <el-col :span="5">
                    <el-button type="primary" @click="handleClick('new')">Tambah Makul</el-button>
            </el-col>
        </el-col>
    ...
    <sweet-modal ref="openDosen">
        ...
        <data-tables :data="$store.state.admin_dosen.data" :pagination-props="{ pageSizes: [8, 10, 15] }" :action-col="actionColDosen">
            <el-table-column v-for="title in titlesDosen" :prop="title.prop" :label="title.label" :key="title.label">
            </el-table-column>
        </data-tables>
