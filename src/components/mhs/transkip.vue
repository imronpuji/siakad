  ...
  <div class="test">
    ...
    <el-col :span="5">
      ...
      <el-dropdown @command="cetakKhs">
          ...
          <el-dropdown-menu slot="dropdown" >
            <el-dropdown-item 
            v-for="data in $store.state.mhs_transkip.semester" :key="data.semester"
            :command="data.semester"
            
            
           >SMT {{data.semester}}</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </el-col>
    ...
    <tr style="border:0px solid" align="right">
    ...
    <tr v-for="(data, index) in $store.state.mhs_transkip.data" :key="index">
        <td style="text-align:center">{{index + 1}}</td>
        <td>{{data.nama_makul}}</td>
        <td style="text-align:center">{{data.nilai_huruf}}</td>
        <td style="text-align:center">{{data.nilai_angka}}</td>
...
export default {
  ...
  data(){
    ...
    allSks(){return this.$store.state.mhs_transkip.allSks},
      
      allHasil(){return this.$store.state.mhs_transkip.allHasil},

    semester : {
        get(){return this.$store.state.mhs_transkip.semester},
      set(value){
